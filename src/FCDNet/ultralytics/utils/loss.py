...
from .metrics import bbox_iou, bbox_mpdiou, bbox_inner_iou, bbox_focaler_iou, bbox_inner_mpdiou, bbox_focaler_mpdiou, wasserstein_loss, WiseIouLoss
...
class v8DetectionLoss:
    ...
    def __init__(self, model):  # model must be de-paralleled
        ...
        self.bce = ASALoss(nn.BCEWithLogitsLoss(reduction='none'))  # Adaptive Sample Attention Loss
    ...
    def compute_loss(self, preds, batch):
        ...
        if isinstance(self.bce, (ASALoss, SlideLoss)):
            if fg_mask.sum():
